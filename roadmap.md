...
- [ ] Usar exclusivamente `logradouros_dne` na normalização de endereço do TXT BPA-I.
- [ ] Validar os cenários A–J e confirmar Registro 03 com 338 posições.
- [ ] Executar geração real sem alterar o cadastro dos pacientes.
