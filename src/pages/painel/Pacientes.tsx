...
const Pacientes: React.FC = () => {
  ...
  const openEdit = (p: (typeof pacientes)[0]) => {
    ...
    setForm({
      ...
      cpf: p.cpf || "",
      cns: p.cns || "",
      nomeMae: p.nomeMae || (p as any).nome_mae || "",
      telefone: p.telefone || "",
      dataNascimento: p.dataNascimento || (p as any).data_nascimento || "",
      email: p.email || "",
      endereco: p.endereco || "",
      descricaoClinica: p.descricaoClinica || (p as any).descricao_clinica || "",
      cid: p.cid || "",
