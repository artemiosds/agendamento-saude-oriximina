...
const MUNICIPIOS = [
  ...
  'Nhamundá', 'Parintins', 'Santarém', 'Alenquer', 'Monte Alegre', 'Outro',
];

const UBS_LIST = [
  'UBS Central', 'UBS Bairro Novo', 'UBS São Francisco', 'UBS Cidade Nova',
  'UBS Santa Terezinha', 'UBS Maracanã', 'Hospital Municipal', 'Outro',
];

const EQUIPAMENTOS_OPTIONS = [
  'Cadeira de rodas', 'Andador', 'Muleta', 'Órtese', 'Prótese', 'Sonda', 'Outro',
];
    ...
    <div className="space-y-4 max-h-[70vh] overflow-y-auto pr-1">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            <Input value={form.telefone} onChange={e => set('telefone', e.target.value)} placeholder="(93) 99999-0000" />
        ...
        {form.menorIdade && (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-2 border-l-2 border-primary/20">
            ...
            <div>
              ...
              <Input value={form.cpfResponsavel} onChange={e => set('cpfResponsavel', e.target.value)} placeholder="000.000.000-00" />
      ...
      <div className="space-y-3 border-t pt-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="sm:col-span-2">
            ...
            <Input value={form.diagnosticoResumido} onChange={e => set('diagnosticoResumido', e.target.value)} placeholder="Resumo em uma linha" />
          </div>
          <div className="sm:col-span-2">
            <Label>Justificativa *</Label>
            <Textarea value={form.justificativa} onChange={e => set('justificativa', e.target.value)} placeholder="Justificativa clínica para encaminhamento" className="min-h-[60px]" />
            {errors.justificativa && <p className="text-xs text-destructive mt-1">{errors.justificativa}</p>}
          </div>
          <div>
            <Label>Data encaminhamento *</Label>
            <Input type="date" value={form.dataEncaminhamento} onChange={e => set('dataEncaminhamento', e.target.value)} />
          </div>
          <div>
      ...
      <div className="space-y-3 border-t pt-3">
        ...
        <div>
          ...
          <RadioGroup value={form.tipoCondicao} onValueChange={v => set('tipoCondicao', v)} className="flex flex-wrap gap-4">
