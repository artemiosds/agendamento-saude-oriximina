...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/painel/configuracoes',           label: 'Configurações',     icon: Settings,    modulo: 'configuracoes' },
      { to: '/painel/permissoes',              label: 'Permissões',        icon: Lock,        modulo: 'permissoes' },
      { to: '/painel/configuracoes-avancadas', label: 'Config. Avançadas', icon: Settings,    modulo: 'configuracoes' },
    ],
  },
];
